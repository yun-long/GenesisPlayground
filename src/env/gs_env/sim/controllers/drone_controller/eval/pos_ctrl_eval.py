...
def main():
    ...
    with open("src/env/gs_env/sim/controllers/drone_controller/config/pos_ctrl_eval/genesis_env.yaml", "r") as file:
        env_config = yaml.load(file, Loader=yaml.FullLoader)
    with open("src/env/gs_env/sim/controllers/drone_controller/config/pos_ctrl_eval/flight.yaml", "r") as file:
