...
def main():
    ...
    with open("src/env/gs_env/sim/controllers/drone_controller/config/rc_FPV_eval/genesis_env.yaml", "r") as file:
        env_config = yaml.load(file, Loader=yaml.FullLoader)
    with open("src/env/gs_env/sim/controllers/drone_controller/config/rc_FPV_eval/flight.yaml", "r") as file:
